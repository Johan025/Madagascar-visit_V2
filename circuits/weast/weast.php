      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-lg-4">
            <div class="box">
              <img src="./../../pictures/alley.jpg" alt="Image">
              <h4> <i class="fa fa-calendar-days"></i> About 9 days</h4>
              <h2>Rivertrip in Tsiribihina River Cruise</h2>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="box">
              <img src="./../../logo/tsingy.jpg" alt="Image">
              <h4> <i class="fa fa-calendar-days"></i> About 9 days</h4>
              <h2>Rivertrip in Tsiribihina and tsingy BEMARAHA </h2>
        ...
        <div class="row gy-5">
          ...
          <div class=" col-10 w-100 col-md-7">
            <div class="p-3 rounded">
              ...
              <p class="p-0 fs-4.8">Drive to Morondava , beautiful landscape of mountain on the way. Lunch at
                Miandrivazo .Sunseat in Baobab Alley for amazing and unforgettable picture
                <br> Overnight at the hotel
              </p>
            </div>
          </div>
          ...
          <div class=" col-10 w-100 col-md-7">
            <div class="p-3 rounded">
              ...
              <p class="p-0 fs-4.8"> Departure to Bekopaka by 4x 4 car, lunch at Belo/Tsiribihina, Crossing by ferry the
                2 rivers (Tsiribihina and Manambolo), Passing through the dry landscape with a sandy and bumpy road
                <br>Overnight at the hotel
              </p>
              </p>
            </div>
          ...
          <div class=" col-10 w-100 col-md-7">
            <div class="p-3 rounded">
              <h4><i class="fa-regular fa-calendar-days"></i> Day 5:</h4>
              <h2><i class="fa-solid fa-location-dot"></i>Visit of the Tsingy of Bemaraha (limestones)</h2>
              <p class="p-0 fs-4.8"> Departure by 4X4 car for joining the park entrance of the BigTsingy, exploring the
                big tsingy during 3hours until 8hours, it’s depend on your physical condition A strong feeling through
                the bridge hanging of Andamozavaky circuits
                The Tsingy gives you opportunity to see different species of lemurs such as Decken's Sifaka, Red Fronted
                Brown Lemur, Grey Mouse Lemur, home of bird such as Coquerel's Coua, Sickle Billed Vanga, White Headed
                Vanga and many kinds of reptiles.
                <br> Overnight at the hotel
              </p>
            </div>
          </div>
          ...
          <div class=" col-10 w-100 col-md-7">
            <div class="p-3 rounded">
              ...
              <p class="p-0 fs-4.8"> Drive to Morondava , Crossing the ferry of Belo sur Tsiribihina, drive to
                Morondava, Stop on the road for the sacred baobab, baobab in love,Sakalava’s tomb.Stop at the famous and
                unique Alley of Baobab .Sunseat at the Alley of Baobab for an amazing unforgettable picture.
                <br> Overnight at the hotel
              </p>
            </div>
          </div>
          ...
          <div class=" col-10 w-100 col-md-7">
            <div class="p-3 rounded">
              ...
              <p class="p-0 fs-4.8">
                Relax on the beach after the bad road , Visit of the fisherman village through the mangrove with the
                local’s pirogue
                <br> Overnight at the hotel
              </p>
            </div>
