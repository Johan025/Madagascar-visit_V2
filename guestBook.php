...
<head>
    ...
    <title>Guestbook Madagascar-visit</title>
...
<body>
 ...
 <header>
  ...
  <!-- <ul role="menu" class="hzmenu"> -->
    <ul>
      <li id="Home" class="Home"><a title="Home"  href="index.php">Home</a></li>
      ...
      <li id="Guest_Book" class="Guest_Book"><a   class="active" title="Guest_Book" class="g" href="guestBook.php">Guest Book</a></li>
...
<p class="recommandation">The recommandation of some clients about our company and about their travel and tour in MADAGASCAR</p>
<div class="comments">
    ...
    <?php
      foreach($comments as $value): ?>
       <ul>
       <li>
     <b><a href="mailto:<?= $value["comment_author_email"]?>"><?= $value["comment_author"]?></a> </b>  <span><?= $value["comment_date"]?></span>
...
<footer id="footer">
          <div class="footer_contact">
           ...
           <a href="lovasson@yahoo.fr"><p class="mail"><img src="../logo/lettre20x20.png"  width=20 height=20> email: lovasson@yahoo.fr</p></a>
            <p><i class="fa fa-whatsapp" width=20 height=20></i> WhatsApp:<a href="https://wa.me/261347344045"> +261(0)34 73 440 45</a></p>
